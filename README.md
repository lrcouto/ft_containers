...
For this project at 42 São Paulo, we are expected to re-implement the C++98 versions of the Vector, the Map and the Stack, with the Set as a bonus using a red-black tree.
